...
// 1. Explicitly type the Mentor structure to keep the TS compiler happy
interface Mentor {
  id: string | number;
  name: string;
  tagline: string;
...
// 2. Define types for the upgraded FilterBlock component
...
export default function ProfilesPage() {
  ...
  // Safely cast profilesList as Mentor array for typing certainty
  const filteredProfiles = (profilesList as Mentor[]).filter((mentor) => {
